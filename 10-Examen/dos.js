...
function mostrar()
{
  ...
  do
  {
    ...
    if(sexo!="masculino")
    {
      if(flagPrimeraNotaNoMasculino==true)
      {
        mayorNotaNoMasculino=notaPromedio;
        nombreMayorNotaNoMasculino=nombre;
        flagPrimeraNotaNoMasculino=false;
      }
    ...
    if (tipoCursada!="remota")
    {
      ...
      else if (cantidadMaterias>mayorCantidadMaterias)
      {
        edadMasMateriasNoRemota=edad;
        nombreMasMateriasNoRemota=nombre;
      }
  ...
  document.writeln("d) La edad y nombre del que cursa mas materias que no sean en forma remota "+edadMasMateriasNoRemota+" y " +nombreMasMateriasNoRemota);
